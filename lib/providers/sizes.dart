...
class Sizes {
  ...
  static double get backgroundHeight => 18 * blockLength;
  static Vector2 get backgroundSize => Vector2(backgroundWidth, backgroundHeight);
  ...
  static Vector2 get characterAreaSize => Vector2(characterAreaWidth, characterAreaHeight);
  static double get characterAreaX => gameOriginX;
  static double get characterAreaY => gameOriginY + 5 * blockLength;
  static Vector2 get characterAreaPosition => Vector2(characterAreaX, characterAreaY);

  // Character

  static double get playerAreaWidth => 4 * blockLength;
  static double get playerAreaHeight => characterAreaHeight;
  static Vector2 get playerAreaSize => Vector2(playerAreaWidth, playerAreaHeight);
  ...
  static Vector2 get buttonAreaSize => Vector2(buttonAreaWidth, buttonAreaHeight);
  ...
  static Vector2 get wideButtonSize => Vector2(wideButtonWidth, wideButtonHeight);
  ...
  static Vector2 get mapCardAreaSize => Vector2(mapCardAreaWidth, mapCardAreaHeight);
  ...
  static double get dialogWidth => 8 * blockLength;
  static double get dialogHeight => 12 * blockLength;
  static Vector2 get dialogSize => Vector2(dialogWidth, dialogHeight);
